...
//    tabBar.tintColor = white;
    ...
    UIImage *albumImg = [[UIImage imageNamed:@"tb_album"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    UITabBarItem *albumTab = self.tabBar.items[3];
    albumTab.image = albumImg;
    albumTab.selectedImage = albumImg;
