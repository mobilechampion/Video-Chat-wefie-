...
@property (weak, nonatomic) IBOutlet UIImageView *mergeImageOne;
@property (weak, nonatomic) IBOutlet UIImageView *mergeImageTwo;
@property (weak, nonatomic) IBOutlet UIImageView *mergeImage;
@property (weak, nonatomic) IBOutlet UIButton *importImageBtn;

- (IBAction)importImageBtnClicke:(id)sender;
